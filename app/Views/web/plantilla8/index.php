...
<head>
<title>Genesis #8- Plantilla Diseño WEB</title>
<meta http-equiv="Content-type" content="text/html; charset=utf-8" />
<link rel="stylesheet" href="assets/web/template8/css/style.css" type="text/css" media="all" />
<link rel="stylesheet" href="assets/web/template8/css/jquery.jcarousel.css" type="text/css" media="all" />
<link rel="stylesheet" href="assets/web/template8/css/skin.css" type="text/css" media="all" />
<link rel="shortcut icon" type="image/x-icon" href="assets/web/template8/css/images/favicon.ico" />
<script src="assets/web/template8/js/jquery-1.4.2.min.js" type="text/javascript" charset="utf-8"></script>
<script src="assets/web/template8/js/jquery.jcarousel.js" type="text/javascript" charset="utf-8"></script>
<script src="assets/web/template8/js/png-fix.js" type="text/javascript" charset="utf-8"></script>
<script src="assets/web/template8/js/fn.js" type="text/javascript" charset="utf-8"></script>
<!--[if IE 6]><link rel="stylesheet" href="assets/web/template8/css/ie6.css" type="text/css" media="all" /><![endif]-->
</head>
<body>
<!-- START PAGE SOURCE -->
<div id="header">
  <div class="shell">
    ...
    <div id="nav">
      <ul>
        ...
        <li><a href="<?=base_url()?>/plantilla"><strong>Plantilla #1<span>ver modelo</span></strong></a></li>
  ...
  <div class="shell">
    <div class="slider">
      <ul id="mycarousel" class="jcarousel-skin-tango">
        <li>
          <div class="image"> <img src="assets/web/template8/css/images/iphone.png" alt="" /> </div>
          <div class="info">
            <h2>slide 1</h2>
  ...
  <div class="shell">
    <div class="triple">
      <ul>
        <li>
          <h3>The Company</h3>
          <img src="assets/web/template8/css/images/img1.gif" alt="" />
        ...
        <li class="last">
          <h3>Screenshots</h3>
          <div class="screens"> <a href="#"><img src="assets/web/template8/css/images/thumb1.jpg" alt="" /></a> <a href="#"><img src="assets/web/template8/css/images/thumb2.jpg" alt="" /></a> <a href="#"><img src="assets/web/template8/css/images/thumb3.jpg" alt="" /></a> <a href="#"><img src="assets/web/template8/css/images/thumb4.jpg" alt="" /></a> <a href="#"><img src="assets/web/template8/css/images/thumb5.jpg" alt="" /></a> <a href="#"><img src="assets/web/template8/css/images/thumb6.jpg" alt="" /></a> </div>
        </li>
        <li>
          <h3>Services</h3>
          <img src="assets/web/template8/css/images/img2.gif" alt="" />
