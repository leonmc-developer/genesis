...
<head>
    ...
    <title>Genesis #3- Plantilla Diseño WEB</title>
	<!-- core CSS -->
    <link href="assets/web/template3/css/bootstrap.min.css" rel="stylesheet">
    <link href="assets/web/template3/css/font-awesome.min.css" rel="stylesheet">
    <link href="assets/web/template3/css/animate.min.css" rel="stylesheet">
    <link href="assets/web/template3/css/owl.carousel.css" rel="stylesheet">
    <link href="assets/web/template3/css/owl.transitions.css" rel="stylesheet">
    <link href="assets/web/template3/css/prettyPhoto.css" rel="stylesheet">
    <link href="assets/web/template3/css/main.css" rel="stylesheet">
    <link href="assets/web/template3/css/responsive.css" rel="stylesheet">
    <!--[if lt IE 9]>
    <script src="assets/web/template3/js/html5shiv.js"></script>
    <script src="assets/web/template3/js/respond.min.js"></script>
    <![endif]-->       
    <link rel="shortcut icon" href="assets/web/template3/images/ico/favicon.ico">
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="assets/web/template3/images/ico/apple-touch-icon-144-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="assets/web/template3/images/ico/apple-touch-icon-114-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="assets/web/template3/images/ico/apple-touch-icon-72-precomposed.png">
    <link rel="apple-touch-icon-precomposed" href="assets/web/template3/images/ico/apple-touch-icon-57-precomposed.png">
</head><!--/head-->
...
<body id="home" class="homepage">
        ...
        <nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="assets/web/template3/images/logo.png" alt="logo"></a>
                </div>
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="scroll"><a href="<?=base_url()?>/plantilla">Plantilla #4</a></li>                   
                    </ul>
                </div>
            </div><!--/.container-->
        </nav><!--/nav-->
    ...
    <section id="main-slider">
        <div class="owl-carousel">
            <div class="item" style="background-image: url(assets/web/template3/images/slider/bg1.jpg);">
             ...
             <div class="item" style="background-image: url(assets/web/template3/images/slider/bg2.jpg);">
                <div class="slider-inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 wow fadeInLeft">
                    <img class="img-responsive" src="assets/web/template3/images/main-feature.png" alt="">
                </div>
                <div class="col-sm-6">
    ...
    <section id="cta2">
        <div class="container">
            <div class="text-center">
                ...
                <img class="img-responsive wow fadeIn" src="assets/web/template3/images/cta2/cta2-img.png" alt="" data-wow-duration="300ms" data-wow-delay="300ms">
            </div>
        </div>
    </section>
            ...
            <div class="portfolio-items">
                <div class="portfolio-item creative">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="assets/web/template3/images/portfolio/01.jpg" alt="">
                        <div class="portfolio-info">
                            <h3>Portfolio Item 1</h3>
                            Lorem Ipsum Dolor Sit
                            <a class="preview" href="assets/web/template3/images/portfolio/full.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                        </div>
                    </div>
                </div><!--/.portfolio-item-->
                ...
                <div class="portfolio-item corporate portfolio">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="assets/web/template3/images/portfolio/02.jpg" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item creative">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="assets/web/template3/images/portfolio/03.jpg" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item corporate">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="assets/web/template3/images/portfolio/04.jpg" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item creative portfolio">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="assets/web/template3/images/portfolio/05.jpg" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item corporate">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="assets/web/template3/images/portfolio/06.jpg" alt="">
                        <div class="portfolio-info">
                            <h3>Portfolio Item 5</h3>
                            Lorem Ipsum Dolor Sit
                            <a class="preview" href="assets/web/template3/images/portfolio/full.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                ...
                <div class="portfolio-item creative portfolio">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="assets/web/template3/images/portfolio/07.jpg" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item corporate">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="assets/web/template3/images/portfolio/08.jpg" alt="">
                        <div class="portfolio-info">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="0ms">
                        <div class="team-img">
                            <img class="img-responsive" src="assets/web/template3/images/team/01.jpg" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Bin Burhan</h3>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="100ms">
                        <div class="team-img">
                            <img class="img-responsive" src="assets/web/template3/images/team/02.jpg" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Jane Man</h3>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="200ms">
                        <div class="team-img">
                            <img class="img-responsive" src="assets/web/template3/images/team/03.jpg" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Pahlwan</h3>
                            <span>Designer</span>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="300ms">
                        <div class="team-img">
                            <img class="img-responsive" src="assets/web/template3/images/team/04.jpg" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Nasir uddin</h3>
                            <span>UI/UX</span>
                    ...
                    <div id="carousel-testimonial" class="carousel slide text-center" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <p><img class="img-circle img-thumbnail" src="assets/web/template3/images/testimonial/01.jpg" alt=""></p>
            ...
            <div class="row">
                        ...
                        <article>
                            <header class="entry-header">
                                <div class="entry-thumbnail">
                                    <img class="img-responsive" src="assets/web/template3/images/blog/01.jpg" alt="">
                ...
                <div class="col-sm-6">
                    <div class="blog-post blog-media wow fadeInRight" data-wow-duration="300ms" data-wow-delay="100ms">
                        <article class="media clearfix">
                            <div class="entry-thumbnail pull-left">
                                <img class="img-responsive" src="assets/web/template3/images/blog/02.jpg" alt="">
                    ...
                    <div class="blog-post blog-media wow fadeInRight" data-wow-duration="300ms" data-wow-delay="200ms">
                        <article class="media clearfix">
                            <div class="entry-thumbnail pull-left">
                                <img class="img-responsive" src="assets/web/template3/images/blog/03.jpg" alt="">
    ...
    <script src="assets/web/template3/js/jquery.js"></script>
    <script src="assets/web/template3/js/bootstrap.min.js"></script>
    <script src="http://maps.google.com/maps/api/js?sensor=true"></script>
    <script src="assets/web/template3/js/owl.carousel.min.js"></script>
    <script src="assets/web/template3/js/mousescroll.js"></script>
    <script src="assets/web/template3/js/smoothscroll.js"></script>
    <script src="assets/web/template3/js/jquery.prettyPhoto.js"></script>
    <script src="assets/web/template3/js/jquery.isotope.min.js"></script>
    <script src="assets/web/template3/js/jquery.inview.min.js"></script>
    <script src="assets/web/template3/js/wow.min.js"></script>
    <script src="assets/web/template3/js/main.js"></script>
</body>
</html>