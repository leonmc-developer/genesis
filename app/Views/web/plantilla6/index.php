...
<head>
    ...
    <!-- Site Metas -->
    <title>Genesis #6- Plantilla Diseño WEB</title>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="assets/web/template6/css/bootstrap.min.css" />
    <!-- Pogo Slider CSS -->
    <link rel="stylesheet" href="assets/web/template6/css/pogo-slider.min.css" />
    <!-- Site CSS -->
    <link rel="stylesheet" href="assets/web/template6/css/style.css" />
    <!-- Responsive CSS -->
    <link rel="stylesheet" href="assets/web/template6/css/responsive.css" />
    <!-- Custom CSS -->
    <link rel="stylesheet" href="assets/web/template6/css/custom.css" />

    <!--[if lt IE 9]>
      <script src="https://oss.maxcdn.com/libs/html5shiv/3.7.0/html5shiv.js"></script>
      <script src="https://oss.maxcdn.com/libs/respond.assets/web/template6/js/1.4.2/respond.min.js"></script>
    <![endif]-->
...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <div id="preloader">
        <div class="loader">
            <img src="assets/web/template6/images/loader.gif" alt="#" />
        </div>
    </div>
    <!-- end loader -->
    <!-- END LOADER -->
    ...
    <header class="top-header">
        <nav class="navbar header-nav navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.html"><img src="assets/web/template6/img/logo.png" alt="image"></a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
                        ...
                        <li><a class="nav-link active" style="background:#f2184f;color:#fff;" href="<?=base_url()?>/plantilla">Plantilla #7</a></li>
                    </ul>
                </div>
                <div class="search-box">
                    <input type="text" class="search-txt" placeholder="Search">
                    <a class="search-btn">
                        <img src="assets/web/template6/images/search_icon.png" alt="#" />
                    </a>
                </div>
            </div>
        </nav>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="pogoSlider" id="js-main-slider">
                    <div class="pogoSlider-slide" style="background-image:url(assets/web/template6/img/banner-img.png);">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 col-md-12 text_align_center padding_0">
                    <div class="full">
                        <img class="img-responsive" src="assets/web/template6/img/img-2png.png" alt="#" />
                    </div>
                </div>
        ...
        <div class="container">
			...
			<div class="row margin-top_30">
			   ...
			   <div class="col-sm-6 col-md-4">
			     <div class="service_blog">
				    <div class="service_icons">
					   <img width="75" height="75" src="assets/web/template6/img/icon-1.png" alt="#">
					</div>
					<div class="full">
			   ...
			   <div class="col-sm-6 col-md-4">
			     <div class="service_blog">
				    <div class="service_icons">
					   <img width="75" height="75" src="assets/web/template6/img/icon-2.png" alt="#">
					</div>
					<div class="full">
					   <h4>DIGITAL marketing</h4>
					</div>
			   ...
			   <div class="col-sm-6 col-md-4">
			     <div class="service_blog">
				    <div class="service_icons">
					   <img width="75" height="75" src="assets/web/template6/img/icon-3.png" alt="#">
					</div>
					<div class="full">
					   <h4>DIGITAL marketing</h4>
					</div>
			   ...
			   <div class="col-sm-6 col-md-4">
			     <div class="service_blog">
				    <div class="service_icons">
					   <img width="75" height="75" src="assets/web/template6/img/icon-4.png" alt="#">
					</div>
					<div class="full">
					   <h4>DIGITAL marketing</h4>
					</div>
			   ...
			   <div class="col-sm-6 col-md-4">
			     <div class="service_blog">
				    <div class="service_icons">
					   <img width="75" height="75" src="assets/web/template6/img/icon-5.png" alt="#">
					</div>
					<div class="full">
					   <h4>DIGITAL marketing</h4>
					</div>
			   ...
			   <div class="col-sm-6 col-md-4">
			     <div class="service_blog">
				    <div class="service_icons">
					   <img width="75" height="75" src="assets/web/template6/img/icon-6.png" alt="#">
					</div>
					<div class="full">
					   <h4>DIGITAL marketing</h4>
					</div>
                            ...
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-lg-3 col-md-6 col-sm-12">
                                        <img class="img-responsive" src="assets/web/template6/images/img1.png" alt="#" />
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-sm-12">
                                        <img class="img-responsive" src="assets/web/template6/images/img2.png" alt="#" />
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-sm-12">
                                        <img class="img-responsive" src="assets/web/template6/images/img3.png" alt="#" />
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-sm-12">
                                        <img class="img-responsive" src="assets/web/template6/images/img4.png" alt="#" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="carousel-item active">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="full">
										   <div class="full team_member_img text_align_center"> 
										      <img src="assets/web/template6/img/img-7.png" alt="#" />
                                ...
                                <li><a href="#"><i class="fa fa-google-plus"></i></a></li>
                                   ...
                                   <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="full">
										   <div class="full team_member_img text_align_center"> 
										      <img src="assets/web/template6/img/img-8.png" alt="#" />
											 <div class="social_icon_team">
											    <ul class="social_icon">
                                <li><a href="#"><i class="fa fa-facebook-f"></i></a></li>
                                <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                                ...
                                <li><a href="#"><i class="fa fa-google-plus"></i></a></li>
                                   ...
                                   <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="full">
										   <div class="full team_member_img text_align_center"> 
										      <img src="assets/web/template6/img/img-9.png" alt="#" />
											 <div class="social_icon_team">
											    <ul class="social_icon">
                                <li><a href="#"><i class="fa fa-facebook-f"></i></a></li>
                                <li><a href="#"><i class="fa fa-twitter"></i></a></li>
  ...
  <ul class="carousel-indicators">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 margin-bottom_30">
				   <img src="assets/web/template6/img/f_logo.png" alt="#" />
				</div>
               <div class="col-xl-6 white_fonts">
					...
					<div class="col-md-12 white_fonts margin-bottom_30">
					   <h3>Contact Us</h3>
                        ...
                        <div class="col-md-4">
                            <div class="full icon">
                                <img src="assets/web/template6/images/social1.png">
                            </div>
                        ...
                        <div class="col-md-5">
                            <div class="full icon">
                                <img src="assets/web/template6/images/social2.png">
                            </div>
                            <div class="full white_fonts">
                        ...
                        <div class="col-md-3">
                            <div class="full icon">
                                <img src="assets/web/template6/images/social3.png">
                            </div>
                            <div class="full white_fonts">
                                <p>+7586656566
                                    <br>+7586656566</p>
    ...
    <!-- ALL JS FILES -->
    <script src="assets/web/template6/js/jquery.min.js"></script>
	<script src="assets/web/template6/js/popper.min.js"></script>
    <script src="assets/web/template6/js/bootstrap.min.js"></script>
    <!-- ALL PLUGINS -->
    <script src="assets/web/template6/js/jquery.magnific-popup.min.js"></script>
    <script src="assets/web/template6/js/jquery.pogo-slider.min.js"></script>
    <script src="assets/web/template6/js/slider-index.js"></script>
    <script src="assets/web/template6/js/smoothscroll.js"></script>
    <script src="assets/web/template6/js/form-validator.min.js"></script>
    <script src="assets/web/template6/js/contact-form-script.js"></script>
    <script src="assets/web/template6/js/isotope.min.js"></script>
    <script src="assets/web/template6/js/images-loded.min.js"></script>
    <script src="assets/web/template6/js/custom.js"></script>
	<script>
	/* counter js */
